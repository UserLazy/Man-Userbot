...
# thanks to phoenix-chan for url
...
async def pat(e):
    ...
    if "g" in switch:
        ...
        def c(j):
            return os.path.splitext(j)[1] in [".png", ".jpg", ".jpeg"]
    ...
    await asyncio.wait(
        [e.respond(caption, file=link, reply_to=e.reply_to_msg_id), e.delete()]
    )
...
CMD_HELP.update(
    {
        "pat": "**Plugin : **`pat`\
        \n\n  •  **Syntax :** `.pat`\
        \n  •  **Function : **Mengirim foto / gift mengelus rambut secara random.\
    "
    }
)
